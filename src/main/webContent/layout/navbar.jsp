<div class="container-fluid bg-dark">
	...
	<nav class="container navbar navbar-expand-lg navbar-light ">
		...
		<a class="navbar-brand text-white" href="#"> <img
			src="./assets/imgs/logo.png" width="30" height="30" /> <span
			class="ml-3">T Shopping</span></a>
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item text-white"><a class="nav-link text-white "
					href="#">Home<i class="fas fa-house"></i>
				</a></li>
				...
				<li class="nav-item dropdown"><a
					...
					data-toggle="dropdown" aria-expanded="false"> Member </a>
